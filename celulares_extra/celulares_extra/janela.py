...
class Aplicacao():
    ...
    def inputs(self):
        ...
        self.inpID.place(relx=0.34, rely=0.25, relwidth=0.080, relheight=0.6)
    ...
    def lista_frame2(self):
        ...
        self.listaNot.column('#2', width=250)
        self.listaNot.column('#3', width=100)
    ...
    def buscar_note(self):
        ...
        self.listaNot.insert("", "end", values=linhas[1])
        self.listaNot.insert("", "end", values=linhas[2])
